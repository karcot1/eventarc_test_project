...
def analyze_image(image_file) -> str | None:
    ...
    print(image)
    context = 'This image is a US patent filling. Abstract the patent number, the patent owner, the date of the patent, and a summary of the patent in 3 sentences or less. Format the patent date as YYYY-MM-DD. Format the output as a json object.'
